													...
													<td>
														...
														@php 
															...
															if( $u->due_status == 1 ){		
																...
																$whatsapp_message = urlencode("Dearsss $u->user_name, you have paid Rs:$u->plan_amount for the date $date of vasantham chit fund $u->plan_name. Thank you. - Vasantham Home Appliances - Siru Semippu Thittam.");
